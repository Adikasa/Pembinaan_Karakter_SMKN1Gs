          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Pelanggaran dan Sanksi -<small><font color="red"> Pelanggaran</font></small></h3>
              ...
              <div class="title_right">
                <div class="col-md-1 col-sm-5 col-xs-12 form-group pull-right top_search">
                  <div class="input-group">
                    <h4><a href="#"><font color="red">Bantuan</font></a></h4>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row top_tiles">
              <div class="animated flipInY col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  <br>
                  <h4 align="center">Daftar Kategori Pelanggaran</h4>

                  <!-- Modal Kategori Pelanggaran -->
                  <h3><div align="center">
                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#kat">lihat</button>
                  </div></h3>
              ...
              <div class="animated flipInY col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="tile-stats">
                <br>
                <h4 align="center">Daftar Sub Kategori Pelanggaran</h4>
                  <!-- Modal Sub Kategori Pelanggaran -->
                <div align="center">
                <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#subkat"> lihat</button></div>
            ...
            <?php } ?>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Poin Pelanggaran dan Sanksi -<small><Font Color=red>Data Master</font></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
