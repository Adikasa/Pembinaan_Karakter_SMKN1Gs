          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Program Keahlian<small></small></h3>
              </div>
            ...
            <div class="clearfix"></div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Data Program Keahlian | SMK Negeri 1 Gunung Sindur</h2>
                    <div class="clearfix"></div>
                  </div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Kd. Prog </th>
                            <th class="column-title">Prog. Keahlian </th>
                            <?php
                              if($_SESSION['akses']==1){
                            ?>
